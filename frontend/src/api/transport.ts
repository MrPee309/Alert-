...
export const transportApi = {
  ...
  markArrived: (id: string) => apiClient.post<TransportRequest>(`/transport/requests/${id}/arrived`),

  startTrip: (id: string) => apiClient.post<TransportRequest>(`/transport/requests/${id}/start`),
